...
3. Initialize the database.
   ...
   psql -U postgres -d wiib -f sql/init.sql      # business + quant + AI runtime (33 tables)
   psql -U postgres -d wiib -f sql/bstock.sql    # bStock static table + 10 seed tickers (34 in total)
   ```
